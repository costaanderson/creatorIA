...
Conta: @brurodrigues_design / Brurodrigues Design
"""
import argparse, os, sys, time, requests
from pathlib import Path
from dotenv import load_dotenv

# Encontra o .env automaticamente
...
def run(images: list, caption: str, dry_run: bool = False):
    ...
    print(f"\nPublicando {len(images)} slides no Instagram (@brurodrigues_design)...")
    if dry_run:
...
if __name__ == "__main__":
    ...
    parser.add_argument("--images", nargs="+", required=True, help="Caminhos das imagens (min 2, max 10)")
